...
const resources: Resource[] = [
  ...
  { name:"PPT Master", type:"Skill", description:"把 PDF、DOCX、网页或主题转为原生可编辑 PPTX：保留文本、图表、形状、动画与演讲者备注。", category:"内容与设计", tags:["PPTX","原生可编辑","AI 演示","PPT Master"], icon:"PPT", tint:"#edf4ff", featured:true, cover:"/cases/deerflow-ppt-card-cover-reference.png", detailCover:"/cases/deerflow-ppt-detail-cover-reference.png", caseTitle:"从源材料到可继续编辑的原生演示文稿", caseSummary:"从 PDF、DOCX、网页、Markdown 或主题出发，生成真实的 PowerPoint 对象；支持原生图表、模板复用、转场、动画与旁白。", prompt:"使用 PPT Master，把 projects/report.pdf 转成一份 10 页、16:9 的原生可编辑 PPTX，并沿用简洁商务风格。", author:"Hugo He", platform:"支持 Codex、Claude Code、Cursor、VS Code + Copilot 等具备 Agent 能力的工具；本地运行并导出 PPTX。", githubUrl:"https://github.com/hugohe3/ppt-master" },
